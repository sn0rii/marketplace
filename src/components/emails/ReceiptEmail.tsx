...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Twój rachunek z BAZAR&apos;ku</Preview>
        ...
        <Container style={container}>
          <Section>
            ...
            <Column align="right" style={tableCell}>
              <Text style={heading}>Rachunek</Text>
            </Column>
          </Section>
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>DATA RACHUNKU</Text>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>NUMER ZAMÓWIENIA</Text>
                <Link
                  style={{
                    ...informationTableValue,
                  }}
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Kwota zamówienia</Text>
          </Section>
          ...
          <Section>
            ...
            <Column style={{ paddingLeft: "40px", paddingTop: 20 }}>
              <Text style={productTitle}>Stała opłata tranzakcyjna</Text>
            </Column>
          ...
          <Text style={footerLinksWrapper}>
            <Link href="#">Ustawienia konta</Link> •{" "}
            <Link href="#">Zasady sprzedaży</Link> •{" "}
            <Link href="#">Polityka Prywatności </Link>
          </Text>
          <Text style={footerCopyright}>
            Copyright © 2023 Bazarek. <br />{" "}
            <Link href="#">Wszystkie prawa zastrzeżone</Link>
          </Text>
        </Container>
      </Body>
    </Html>
