            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt6 text-sm font-medium text-muted-foreground">
                <div className="flex justify-between">
                  <p>Łączna cena produktów</p>
                  <p className="text-gray-900">{formatPrice(orderTotal)}</p>
                </div>
                <div className="flex justify-between">
                  <p>Stała opłata tranzakcyjna</p>
                  <p className="text-gray-900">{formatPrice(5)}</p>
                </div>

                <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                  <p className="text-base">Łącznie</p>
                  <p className="text-base">{formatPrice(orderTotal + 5)} </p>
                </div>
              </div>
